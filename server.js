  ...
  return records
    .map((record) => ({
      ...
      overrides: {
        ...
        behaviorValues: normalizeMention(record.overrides?.behaviorValues),
        formal: normalizeMention(record.overrides?.formal),
        final: normalizeMention(record.overrides?.final),
        philosophyFinal: normalizeMention(record.overrides?.philosophyFinal),
      },
      formalAssessments: {
        ...
        philosophyAb: normalizeMention(record.formalAssessments?.philosophyAb),
        philosophyAbRecovery: normalizeMention(record.formalAssessments?.philosophyAbRecovery),
      },
      statusOverride: normalizeGradeStatus(record.statusOverride),
      philosophyStatusOverride: normalizeGradeStatus(record.philosophyStatusOverride),
...
async function saveGradeRecord(res, body, user) {
  ...
  if (existing) {
    Object.assign(existing, {
      ...
      philosophyStatusOverride: incoming.philosophyStatusOverride,
